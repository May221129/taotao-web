...
<body id="mainframe">
	...
	<form id="orderForm" class="hide">
		...
		<input type="hidden" name="orderShipping.receiverMobile"
			value="15800000000" /> <input type="hidden"
			name="orderShipping.receiverState" value="上海" /> <input type="hidden"
			name="orderShipping.receiverCity" value="上海" /> <input type="hidden"
			name="orderShipping.receiverDistrict" value="闵行区" /> <input
			type="hidden" name="orderShipping.receiverAddress"
			value="三鲁公路3279号 明浦广场 3号楼 205室 " />
	</form>
	<div class="w w1 header clearfix">
		<div id="logo">
			<a href="http://www.taotao.com/"><img
				src="/images/taotao-logo.gif" alt="淘淘商城" /></a>
		</div>
			...
			<div id="wizard" class="checkout-steps">
				<div id="step-1" class="step step-complete">
					<div class="step-title">
						...
						<strong id="consigneeTitleDiv">收货人信息</strong> <span
							class="step-action" id="consignee_edit_action"><a
							href="#none" onclick="edit_Consignee()">[修改]</a></span>
					</div>
					<div class="step-content">
						<div id="consignee" class="sbox-wrap">
							<div class="sbox">
								<div class="s-content">
									<p>
										花和尚 &nbsp; 15800007000 &nbsp; &nbsp; <br /> 上海 闵行区 外环以外 &nbsp;
				...
				<div id="step-2" class="step step-complete">
					...
					<div class="step-title">
						...
						<strong>支付及配送方式</strong> <span class="step-action"
							id="payment-ship_edit_action"><a href="#none"
							...
							<div class="sbox">
								<div class="s-content payment-info">
									<div class="payment-selected">
										在线支付 <span id="baitiaomessage" style="display: none"><font
											color="#FF6600;">&nbsp;使用在线支付支持打白条</font></span> <span
											class="easyPayWarning"></span>
									</div>
				...
				<div id="step-3" class="step step-complete">
					...
					<div class="step-title">
						...
						<strong>发票信息</strong> <span class="step-action"
							id="part-invoice_edit_action"><a href="#none"
							onclick="edit_Invoice()">[修改]</a></span>
					</div>
					<div class="step-content">
								...
								<div class="invoice">
									<div class="invoice-content">
										...
										<div class="invoice-note" style="display: none">
											备注：如商品由第三方卖家销售，发票内容由其卖家决定，发票由卖家开具并寄出 <a href="#none"
												class="tips-i" id="bill-tip-btn">&nbsp;</a>
									...
									<div class="order-review">
														...
														<tbody>
															<tr>
																<td class="fore1">
																	<div class="p-goods">
																		<div class="p-img">
																			<a href="http://www.taotao.com/item/${item.id}.html"
										...
										<div class="order-summary">
											...
											<div class="statistic fr">
												<div class="list">
													<span><em id="span-skuNum">1</em> 件商品，总商品金额：</span><em
												...
												<div class="list" id="showFreightPrice"
													...
													<span id="freightSpan" style="width: 40px;">运费：</span> <em
														class="price" id="freightPriceId"> ￥0.00</em>
												</div>
												<div class="list">
													<span>应付总额：</span><em id="sumPayPriceId" class="price">
...
.checkout-buttons .checkout-submit-disabled b {
	...
	<div class="bt bt-w freight-tooltip hide" id="transport"></div>
	<div class="w">
