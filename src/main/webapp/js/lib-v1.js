...
var category = {OBJ: $("#_JD_ALLSORT"),
		//还没在后台系统中写好代码时，用下面的路径来假装这是后台系统返回的数据：
//		URL_Serv: "/js/item-cat-all.json",
		//写好后台系统的相应的代码后，如果直接用下面这个路径，会存在ajax的跨域请求问题，不能跨域请求：
//		URL_Serv: "http://manage.taotao.com/rest/api/item/cat",
		//jsonp解决了ajax的跨域请求问题后的正确的url：
		URL_Serv: "http://manage.taotao.com/rest/api/item/cat?callback=category.getDataService",
//		URL_Serv: "http://manage.taotao.com/web/item/cat/all?callback=category.getDataService",
